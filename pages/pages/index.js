...
import { Crosshair, Target, Layers } from "lucide-react"; // Example icons
...
export default function Home() {
  ...
  return (
    <>
      ...
      <main ref={scrollRef} className="bg-gradient-to-b from-precision-blue to-focus-blue text-white min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
            <motion.div initial={{x:-40,opacity:0}} whileInView={{opacity:1,x:0}} viewport={{ once:true }} className="text-white fadeInUp">
              ...
              <p className="text-lg font-medium mb-4">
                Manual supplement preparation consumes significant time, adding friction to daily athlete routines.
              </p>
        ...
        {/* Include enquiry form and other sections as needed in your next iteration */}
